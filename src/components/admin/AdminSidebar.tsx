  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="px-5 py-4 border-b border-white/5 flex items-center justify-between">
        <Link href="/">
          <Image src="/logo.png" alt="SteelLine Logistics" width={120} height={48} className="h-16 w-auto object-contain" />
        </Link>
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 inset-x-0 z-40 h-14 bg-[#080c14]/95 backdrop-blur-xl border-b border-white/5 flex items-center px-4 gap-3">
        ...
        <Link href="/">
          <Image src="/logo.png" alt="SteelLine Logistics" width={100} height={40} className="h-16 w-auto object-contain" />
        </Link>
